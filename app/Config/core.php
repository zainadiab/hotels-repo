 ...
 */
	Configure::write('Security.salt', 'DYhG93v0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

	// app/Config/core.php
	Configure::write('Security.salt', 'random_salt_here');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309v57453542496749683645');
